...
from https://github.com/aws/aws-sam-cli/blob/develop/samcli/commands/_utils/template.py
"""
...
class TemplateFailedParsingException(Exception):
    pass
...
def get_template_function_resource_ids(template_file):
    """
